...
public class ValidarInformacoesUsuario {
    ...
    public static String buscarNumeroConta() throws ClassNotFoundException, SQLException{
        BancoDeDados b1 = new BancoDeDados();
        b1.buscarNumeroDaContaBancoDeDados();
        String StringNumeroConta = Integer.toString(Usuario.getNumeroConta());
        return StringNumeroConta;
    }
}