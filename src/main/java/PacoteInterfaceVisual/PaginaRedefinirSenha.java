 ...
 * @author CaioFSX
 */
public class PaginaRedefinirSenha extends javax.swing.JFrame {

    /**
     * Creates new form InterfaceVisual
     */
    public PaginaRedefinirSenha() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        InformeSuaSenha.setText("Informe sua nova Senha:");
        ...
        ConfirmarNovaSenha.setEditable(false);
        ConfirmarNovaSenha.setBackground(new java.awt.Color(255, 255, 255));
        ConfirmarNovaSenha.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ConfirmarNovaSenha.setText("Confirme sua nova Senha:");
        ConfirmarNovaSenha.setBorder(null);
        ConfirmarNovaSenha.setFocusable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaginaRedefinirSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new PaginaRedefinirSenha().setVisible(true);
            }
        });
    }
